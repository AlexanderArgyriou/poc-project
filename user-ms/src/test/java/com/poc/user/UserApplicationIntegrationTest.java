...
class UserApplicationIntegrationTest {
    ...
    public void givenNewUser_whenSaved_userExistsOnDB() {
        ...
        testUserDocument.setId("test");
        testUserDocument.setEmail("test@test.com");
        testUserDocument.setFirstname("testName");
        testUserDocument.setLastname("testLastname");
        testUserDocument.setUsername("testuser");
    ...
    void givenAllEligibleFieldsPopulated_whenCreateNewUser_thenUserCreatedSuccessfully() {
        ...
        testUserInfo.setFirstname("testName");
        ...
        assertTrue(userDocument.isActive());
        assertNull(userDocument.getDeactivatedTimestamp());
    ...
    void givenSpecificUsersExists_whenUsersEdited_thenAllFieldsUpdatedSuccessfully() {
        ...
        userDocument1.setId("test");
        userDocument1.setEmail("test@test.com");
        userDocument1.setFirstname("testName");
        userDocument1.setLastname("testLastname");
        userDocument1.setUsername("testuser");
        ...
        userInfo1.setId("test");
        userInfo1.setEmail("newTest@test.com");
        userInfo1.setUsername("testuser");
        userInfo1.setLastname("newTestlastname");
        ParticularUserInfo userInfo2 = new ParticularUserInfo();
        userInfo2.setId("test2");
        userInfo2.setEmail("newTest2@test.com");
